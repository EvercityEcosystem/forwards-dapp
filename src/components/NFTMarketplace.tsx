          ...
          <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <a href="#">
              ...
              <div className="px-4 py-3 w-80">
                <span className="text-gray-400 mr-3 uppercase text-xs">Mascots</span>
                <p className="text-lg font-bold text-black truncate block capitalize">Mangrove</p>
              </div>
            </a>
          </div>
          <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <a href="#">
              ...
              <div className="px-4 py-3 w-80">
                <span className="text-gray-400 mr-3 uppercase text-xs">Mascots</span>
                <p className="text-lg font-bold text-black truncate block capitalize">Bamboo</p>
              </div>
            </a>
          </div>
        </section>
